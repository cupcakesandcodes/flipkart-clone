...
const Footer = () => {
  ...
  return (
    <>
      {!adminRoute && (
        <>
          <footer className="mt-20 w-full py-1 sm:py-4 px-4 sm:px-12 bg-blue-900 text-white text-xs border-b border-gray-600 flex flex-col sm:flex-row overflow-hidden">
          ...
          <div className="px-16 py-6 w-full bg-blue-900 hidden sm:flex justify-between items-center text-sm text-white">
            <a
